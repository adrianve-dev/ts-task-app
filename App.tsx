...
import { asyncAddTask, asyncDeleteData, asyncUpdateTaskCount, getStoredTasks, getTaskCount } from './utils/api'
...
export default function App() {
  ...
  React.useEffect(() => {
    const initData = async () => {
      ...
      if(count === null) {
        if(storedTasks === null){
          await asyncUpdateTaskCount('0')
        } else {
          await asyncUpdateTaskCount(Object.keys(storedTasks).length.toString())
        }
      }
